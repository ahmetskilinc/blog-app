...
If you havent already read the previous post, do read it if you want to set up a blog like this one. [You can find the tutorial here](/p/build-a-nextjs-blog-tailwind-markdown)
