---
title: Better Syntax Hightlighting with PrismJS
author: Ahmet Kilinc
category: Tutorial
...
<PostHeader title={title} author={author} tags={tags} category={category} date={publishedOn} />

## What is PrismJS?

[PrismJS]() is a lightweight, extensible syntax highlighter that can be used when working with code blocks in markdown files in blog posts.
...
If you havent already read the previous post, do read it if you want to set up a blog like this one. You can fine it [here](/posts/build-a-nextjs-blog-tailwind-markdown)
...
Once you have added the plugin we now need to choose a theme (CSS file) for prism to use. You can find them [here](https://github.com/PrismJS/prism-themes). I'll be using [Coldark Dark](https://raw.githubusercontent.com/PrismJS/prism-themes/master/themes/prism-coldark-dark.css).
